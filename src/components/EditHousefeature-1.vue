<template>
    <div class="feature">
        <h4 class="title">編輯鳥巢特徵-物理性質-2</h4>
        <div class="flexbox">
            <div class="left">
                <div class="wrap">
                    <h5>電器家具</h5>
                    <div class="furwrap">
                        <div class="fur flex" v-for="(fur,index) in itemlist" :key="index">
                ...
                <div class="wrap">
                    ...
                    <dropdown class="drop" dropdownwidth="300px" dropcontentwidth="300px" :locdata="gender" :loc="this.editdata.gender" @clickcity="genderhandler" backgroundColor="#ededed"></dropdown>
                </div>
            </div>
            <div class="right">
...
export default {
    ...
    data() {
        return {
            ...
            feturedata: {
                gender: '',
                fur: this.editdata.fur,
                life_function: this.editdata.life_function,
                pet: this.editdata.pet,
                open_fire: this.editdata.open_fire,
    ...
    methods: {
        ...
        delefur(val) {
            let index = this.itemlist.indexOf(val);
            this.itemlist.splice(index, 1);
            this.$store.commit('setfeturetwodata', this.feturedata)

        },
        addfuritem() {
            // this.itemlist.push(this.furitem);
